...
internal enum Asset {
  ...
  internal enum Images {
    internal static let icArrowBack = ImageAsset(name: "icArrowBack")
    internal static let icReloadArrow = ImageAsset(name: "icReloadArrow")
    internal static let iconDown = ImageAsset(name: "iconDown")
