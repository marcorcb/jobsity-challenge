//
//  ShowsCommonModelExtensions.swift
...
extension CommonData.CommonViewData.Image {
    static var imageShowMock: CommonData.CommonViewData.Image {
        .init(
    ...
    static var imageEpisodeMock: CommonData.CommonViewData.Image {
        .init(
...
extension CommonData.CommonViewData.Links {
    static var linksShowMock: CommonData.CommonViewData.Links {
        .init(
    ...
    static var linksEpisodeMock: CommonData.CommonViewData.Links {
        .init(
