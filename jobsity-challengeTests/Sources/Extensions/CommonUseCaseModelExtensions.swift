//
//  CommonUseCaseModelExtensions.swift
...
extension CommonUseCaseModel.Image {
    static var imageShowMock: CommonUseCaseModel.Image {
        .init(
    ...
    static var imageEpisodeMock: CommonUseCaseModel.Image {
        .init(
...
extension CommonUseCaseModel.Links {
    static var linksShowMock: CommonUseCaseModel.Links {
        .init(
    ...
    static var linksEpisodeMock: CommonUseCaseModel.Links {
        .init(
